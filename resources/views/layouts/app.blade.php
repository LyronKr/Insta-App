        ...
        <main class="py-4">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    @if (request()->is('admin/*'))
                        <div class="col-3">
                            <div class="list-group">
                                <a href="{{ route('admin.users') }}" class="list-group-item {{ request()->is('admin/users') || request()->is('admin/users/search') ? 'active' : '' }}">
                    ...
                    <div class="col-9">
                        @if (request()->is('admin/users') || request()->is('admin/users/search'))
                            <div class="row">
                                <div class="col-3 ms-auto mb-3">
                                    <form action="{{ route('admin.users.search') }}" id="myForm">
                                        <input type="search" name="search_user" id="search-user" class="form-control form-control-sm" placeholder="Search..." value="{{ isset($searched) ? $searched : '' }}" autofocus>
                                    </form>
                                </div>
                            </div>
                        @endif
