...
@section('content')
    <div class="row justify-content-center">
        <div class="col-5">
            ...
            <p class="h5 text-muted mb-4">Suggested</p>
            ...
            @forelse ($suggested_users as $user)
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col ps-0 text-truncate">
                        ...
                        @if ($user->isFollower())
                            <p class="text-secondary small">Follows You</p>
                        @else
                            @if ($user->following->count() > 0)
                                <p class="text-secondary small">{{ $user->following->count() }} Followers</p>
                            @else
                                <p class="text-secondary small">No Followers</p>
                            @endif
                        @endif
                    </div>
                    <div class="col-auto">
